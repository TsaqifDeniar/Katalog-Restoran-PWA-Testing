...
Scenario('Liking a restaurant', async ({ I }) => {
  ...
  const firstRestaurantSelector = '.list-item-title a:first-child';
  const firstRestaurantName = await I.grabTextFrom(firstRestaurantSelector);

  I.click(firstRestaurantSelector);
